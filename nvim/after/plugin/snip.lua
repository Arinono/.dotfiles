...
ls.add_snippets("typescript", {
	...
	s("keys", isn(1, t({ "const keys = Object.keys as <T>(obj: T) => Array<keyof T>" }), "$PARENT_INDENT")),
	s("values", isn(1, t({ "const values = Object.values as <T>(obj: T) => Array<T[keyof T]>" }), "$PARENT_INDENT")),
})

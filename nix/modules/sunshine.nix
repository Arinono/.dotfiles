        ...
        apps = [
          ...
          }
          {
            ...
            prep-cmd = [
              ...
              {
                do = "";
                undo = "sleep 60 ; systemctl suspend";
              }
            ];
            exclude-global-prep-cmd = "false";
            auto-detach = "true";
          }
          {
            ...
            detached = [
              "sudo -u ${cfg.user} setsid steam steam://open/bigpicture"
            ];
            prep-cmd = [
              {
                do = "";
                undo = "sudo -u ${cfg.user} setsid steam steam://close/bigpicture";
              }
            ];
            exclude-global-prep-cmd = "false";
          }
          {
            name = "Steam Big Picture (End Sleep)";
            image-path = "steam.png";
            detached = [
              "sudo -u ${cfg.user} setsid steam steam://open/bigpicture"
            ];
